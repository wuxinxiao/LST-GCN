...
parser.add_argument('--node_feat_dim', type=int, default=512, help='node state size')  #512#2048
parser.add_argument('--edge_feat_dim', type=int, default=516, help='edge state size')  #516#2052
parser.add_argument('--tem_feat_dim', type=int, default=512, help='edge state size') #512#2048
...
parser.add_argument('--niter', type=int, default=500, help='number of epochs to train for')#50 150 300
...
parser.add_argument('--resume', default='/home/mcislab/zhaojw/AAAI/prediction2020/models/ucf101_res18_rgbflow_same_fintuned/num_frames5_lr0.0005/test_with_similarity_matrix/',help='path to latest checkpoint')
parser.add_argument('--logroot', default='/home/mcislab/zhaojw/AAAI/prediction2020/log/ucf101_res18_rgbflow_same_fintuned/num_frames5_lr0.0005/test_with_similarity_matrix/',help='path to latest log')
...
parser.add_argument('--l2', type=int, default=1/8, help='loss type')#0:without MSE loss
parser.add_argument('--l3', type=int, default=1, help='loss type') #0:without MMD loss
parser.add_argument('--split',type=str,default='3',help='the name of root directory')#1#2
...
def main(opt):
    ...
    train_dataset = dataset(train_datalist, paths.res18_ucf_similarity,opt)####zhao changed ###paths.resnet50_ucf_rgbflow_same,resnet50_ucf_rgbflow_same_fintuned,ap_resnet18_ucf
    ...
    test_dataset = dataset(test_datalist, paths.res18_ucf_similarity,opt)###paths.resnet50_ucf_rgbflow_same
