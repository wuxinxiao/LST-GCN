...
def test(epoch,dataloader, model, criterion1,criterion2,  opt,writer,log_file):
    model.eval()
    ...
    with torch.no_grad():
        ...
        #for i, (edge_features, node_features, adj_mat, graph_label) in enumerate(dataloader, 0):
            ...
            #adj_matrixes = adj_mat.contiguous().view(batch*opt.seq_size, n_node, -1).float()  #for IGGNN ablation study
