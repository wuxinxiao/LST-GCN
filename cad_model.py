...
predict_graph using mse loss to constrain
stimulate full graph using mmd loss to constrain
full video and partial video using different embedding parameters
no object feature
using gcn update both gt unseen subgraph and predicted part
version2.1
    ...
    def forward(self, graph_out, init_input, is_test):
        ...
        for seq_ind in range(1,self.seq_size+1):   
            ...
            if seq_ind< self.seq_size:
                ...
                updated_unobserved_nodes = self.gc(unobserved_part, adj)
