...
import zns_ucf101_phase2_model
import datasets
...
parser.add_argument('--resume', default='/home/mcislab/zhaojw/AAAI/prediction2020/models/ucf101_res50_rgbflow_same/phase2_freeze/num_frames8_lr0.0005/1/',help='path to latest checkpoint')
parser.add_argument('--logroot', default='/home/mcislab/zhaojw/AAAI/prediction2020/log/ucf101_res50_rgbflow_same/phase2_freeze/num_frames8_lr0.0005/1/',help='path to latest log')
...
def main(opt):
    '''
    model = zns_ucf101_phase2_model.Model(opt)
    print(model)
    exit()
    '''
    ...
    model_path = '/home/mcislab/zhaojw/AAAI/prediction2020/models/ucf101_res50_rgbflow_same/only_reasoning/num_frames8_lr0.0005/split1/84/model_best.pth'
    checkpoint = torch.load(model_path)
    model.load_state_dict_(checkpoint)
        
    print(len(set(filter(lambda p: p.requires_grad, model.parameters()))))
