...
parser.add_argument('--resume', default='/home/mcislab/wangruiqi/prediction2020/models/sth_try3',help='path to latest checkpoint')
parser.add_argument('--logroot', default='/home/mcislab/wangruiqi/prediction2020/log/sth_try3',help='path to latest checkpoint')
