...
def get_feature(feat_i,anno_file,feat_dir):
    ...
    '''BNInception_flow'''
    if feat_category in ['BNINc_Flow_Feat_last2-V2','ap_BNINc_sample10','BNINc_Flow_Feat_AVG']:
...
def data_sampling(img_list, rgb_dir, flow_dir, video_name,sampling_num):
    ...
    if rgb_dir==flow_dir:
        ...
        flow_feat_path = flow_dir + video_name[:-4] #for BNINC
        #flow_feat_path = flow_dir + video_name  #for 3DResNext
