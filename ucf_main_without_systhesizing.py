...
import ucf_main_without_systhesizing_model
import datasets
...
parser.add_argument('--node_feat_dim', type=int, default=1024, help='node state size')  #512#
parser.add_argument('--edge_feat_dim', type=int, default=1028, help='edge state size')  #516#
parser.add_argument('--tem_feat_dim', type=int, default=1024, help='edge state size') #512#
...
parser.add_argument('--resume', default='/home/mcislab/zhaojw/AAAI/prediction2020/models/ucf101_Incep_v4_rgbflow_same_fintuned/num_frames5_lr0.0005/test_without_sys/',help='path to latest checkpoint')
parser.add_argument('--logroot', default='/home/mcislab/zhaojw/AAAI/prediction2020/log/ucf101_Incep_v4_rgbflow_same_fintuned/num_frames5_lr0.0005/test_without_sys/',help='path to latest log')
