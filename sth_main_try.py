...
parser.add_argument('--resume', default='/home/mcislab/wangruiqi/prediction2020/models/sth_try/',help='path to latest checkpoint')
parser.add_argument('--logroot', default='/home/mcislab/wangruiqi/prediction2020/log/sth_try/',help='path to latest checkpoint')
...
def main(opt):
    ...
    log_file_name = opt.logroot+'something_log_v3.1_'+str(opt.manualSeed)+'.txt'
