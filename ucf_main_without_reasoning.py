...
import ucf_main_without_reasoning_model
import datasets
...
parser.add_argument('--resume', default='/home/mcislab/zhaojw/AAAI/prediction2020/models/ucf101_res50_rgbflow_same/without_reasoning/num_frames8_lr0.0005/1/',help='path to latest checkpoint')
parser.add_argument('--logroot', default='/home/mcislab/zhaojw/AAAI/prediction2020/log/ucf101_res50_rgbflow_same/without_reasoning/num_frames8_lr0.0005/1/',help='path to latest log')
...
def main(opt):
    ...
    model = ucf_main_without_reasoning_model.Model(opt)
