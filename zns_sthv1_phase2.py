...
parser.add_argument('--resume', default='/home/mcislab/zhaojw/AAAI/prediction2020/models/sthv1_phase2/3_freeze/',help='path to latest checkpoint')
parser.add_argument('--logroot', default='/home/mcislab/zhaojw/AAAI/prediction2020/log/sthv1_phase2/3_freeze/',help='path to latest checkpoint')
...
def main(opt):
    ...
    log_file_name = log_path + '/' +'something_log_v4.1_'+str(opt.manualSeed)+'.txt'
    ...
    model = zns_sthv1_phase2_model.Model(opt)
    #print(model)
    #exit()
    
    #phase1:load pretrained reasonning model
    #print(phase1)
    ...
    print(len(set(filter(lambda param:param.requires_grad, model.parameters()))))
    #exit()
    optimizer = optim.Adam(filter(lambda param:param.requires_grad, model.parameters()), lr=opt.lr, weight_decay=opt.weight_decay)
    ...
    if loaded_checkpoint:
        ...
        test_acc, output = test(51,test_dataloader, model, opt, writer, log_file_name, is_test=True)
