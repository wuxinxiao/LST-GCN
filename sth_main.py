...
parser.add_argument('--resume', default='/home/mcislab/wangruiqi/prediction2020/models/sth/',help='path to latest checkpoint')
parser.add_argument('--logroot', default='/home/mcislab/wangruiqi/prediction2020/log/sth/',help='path to latest checkpoint')
...
parser.add_argument('--l2', type=int, default=0.125, help='loss type')
...
def main(opt):
    ...
    log_file_name = opt.logroot+'something_log_V5.1_'+str(opt.manualSeed)+'.txt'
    ...
    if loaded_checkpoint:
        ...
        test_acc, output = test(49,test_dataloader, model, criterion1, criterion2, opt, writer, log_file_name, is_test=True)
