...
from datasets.Sthv2_datasets import dataset
...
parser.add_argument('--classNum', type=int, default=12, help='number of classes')###########
...
parser.add_argument('--max_num_node', type=int, default=3, help='#objects+human')
parser.add_argument('--node_feat_dim', type=int, default=512, help='node state size')#1024
parser.add_argument('--edge_feat_dim', type=int, default=516, help='edge state size')#1028
...
parser.add_argument('--resume', default='/home/mcislab/zhaojw/AAAI/prediction2020/models/sthv2_try3/2/',help='path to latest checkpoint')
parser.add_argument('--logroot', default='/home/mcislab/zhaojw/AAAI/prediction2020/log/sthv2_try3/2/',help='path to latest checkpoint')
...
parser.add_argument('--l2', type=int, default=1/2, help='loss type')#1/8
parser.add_argument('--l3', type=int, default=1/2, help='loss type')#1
