...
parser.add_argument('--resume', default='/home/mcislab/wangruiqi/prediction2020/models/ucf101',help='path to latest checkpoint')
parser.add_argument('--logroot', default='/home/mcislab/wangruiqi/prediction2020/log/ucf101',help='path to latest log')
...
def main(opt):
    ...
    log_file_name = log_path + 'ucf_log_st_'+str(opt.manualSeed)+'.txt'
    ...
    train_dataset = dataset(train_datalist, paths.ap_resnet18_ucf,opt)
    ...
    test_dataset = dataset(test_datalist, paths.ap_resnet18_ucf,opt)
