...
from utils.sthv1_train import train
from utils.sthv1_test import test
from utils.sthv1_val import val
from datasets.dataset_baseline2 import dataset
...
parser.add_argument('--resume', default='/home/mcislab/zhaojw/AAAI/prediction2020/models/sth_try3_baseline2/',help='path to latest checkpoint')
parser.add_argument('--logroot', default='/home/mcislab/zhaojw/AAAI/prediction2020/log/sth_try3_baseline2/',help='path to latest checkpoint')
...
def main(opt):
    ...
    train_datalist = '/home/mcislab/zhaojw/train_list.txt'
    test_datalist = '/home/mcislab/zhaojw/test_list.txt'
    val_datalist = '/home/mcislab/zhaojw/val_list.txt'
    ...
    val_dataset = dataset(val_datalist, paths.detect_root1, paths.img_root, opt)
    
    val_dataloader = DataLoader(val_dataset, batch_size=opt.batch_size, shuffle=True, num_workers=opt.workers, drop_last=False) 
    ...
    for epoch_i in range(opt.epoch, opt.niter):
        ...
        test_acc, output = val(epoch_i, val_dataloader, model, criterion1, criterion2, opt, writer, log_file_name, is_test=True)
